...
def main():
    ...
    if not in_cache_mode:    
        threads = [
            ...
            ScraperThread(program=scrap_articles, news_site="kyiv", keyword=keyword)
        ]
        ...
        kyiv_articles = threads[8].articles
        ...
        if kyiv_active:
            results_kyiv = analyze_articles(kyiv_articles, news_site="kyiv", keyword=keyword)
